...
function Header() {
  return (
    <header className="App-header flexCenter">
      <div>
        <img src="icons/banner.png" alt="Mage Knight"></img>
      </div>
...
function MonsterTuile(props) {
  ...
  if (props.monster) {
    ...
    function deleteMonster() {
      manipulate.deleteMonsterServer(slug);
    ...
    return (
      <div className="monsterTuile flexCenter spaceStart">
        ...
        <div onClick={redirect} className="tuileText">
          <h3>{name}</h3>
          <p>{description}</p>
        </div>
        <div className="tuileSideContainer flexCenter column spaceEvenly">
